          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#"
                  className="text-sm font-medium text-black hover:underline dark:text-black-500"
                >
                  Forgot password?
                </a>
              </div>
              <button
                type="submit"
                className="w-full text-white bg-black hover:bg-black-700 focus:ring-4 focus:outline-none focus:ring-black-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-black dark:hover:bg-black-700 dark:focus:ring-black-800"
              >
                Sign in
              </button>
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <Link
                  to="sing-up"
                  className="font-medium text-black hover:underline dark:text-black-500"
                >
                  Sign up
                </Link>
              </p>
